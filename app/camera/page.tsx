  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-[#f15a09] font-sans text-slate-900 flex flex-col p-4">
      ...
      <div className="relative flex-1 flex flex-col border-[4px] border-white rounded-[30px] overflow-hidden bg-[#f15a09]">
        ...
        <div className="w-full flex justify-between items-center px-6 py-3 shrink-0 h-14 relative">
          <h2 className={`${mochiyPopOne.className} text-white text-lg uppercase tracking-widest drop-shadow-md`}>
            SESI POTRET
          </h2>
          ...
          <button
            ...
            className="absolute left-1/2 -translate-x-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white border-2 border-white/50 px-4 py-1.5 rounded-full font-black text-[9px] tracking-[0.15em] transition-all active:scale-95 flex items-center gap-1.5 drop-shadow-lg"
          >
        ...
        <main className="flex-1 flex flex-col gap-4 px-4 pb-4 overflow-hidden">
          ...
          <div className="flex-[1.2] bg-white rounded-[24px] shadow-2xl overflow-hidden relative border-3 border-white shrink-0">
            ...
            <div className="absolute inset-0 bg-slate-900 overflow-hidden">
              ...
              {countdown !== null && (
                <div className="absolute inset-0 flex items-center justify-center z-30 bg-black/20">
                  <span className={`${mochiyPopOne.className} text-[12rem] text-white drop-shadow-2xl animate-ping`}>{countdown}</span>
                </div>
              )}
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-40 w-full flex items-center justify-center px-6 gap-4">
              {!showPreview ? (
                <>
                  <button
                ...
                <div className="flex items-center gap-4 w-full max-w-md">
                  <button
                    ...
                    className="flex-1 h-14 rounded-2xl bg-white/90 backdrop-blur-md text-[#f15a09] border-3 border-[#f15a09] font-black text-lg tracking-widest shadow-2xl hover:bg-white active:scale-95 transition-all uppercase"
                  >
                    ULANGI
                  </button>
                  <button
                    onClick={handleNext}
                    className="flex-1 h-14 rounded-2xl bg-[#f15a09] text-white font-black text-lg tracking-widest shadow-2xl hover:brightness-110 active:scale-95 transition-all uppercase border-3 border-white/20"
                  >
          ...
          <div className="flex-1 flex gap-4 overflow-hidden min-h-0">
            ...
            <div className="flex-1 bg-white rounded-[24px] shadow-2xl p-4 flex items-center justify-center relative overflow-hidden border-3 border-white">
            {template ? (
              <div
                ...
                <div className="grid grid-cols-4 gap-2">
                  {filters.map(f => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full ${f.color} border-3 transition-all relative mx-auto
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-1">
                    <div className="flex justify-between items-center px-0.5">
                      ...
                      <span className="text-[9px] font-black text-[#f15a09]">{currentEdit.brightness}</span>
                    </div>
                    <input
                      type="range" min="-50" max="50" value={currentEdit.brightness}
                      onChange={(e) => updateEdit("brightness", Number(e.target.value))}
                      className="w-full h-2 bg-slate-100 rounded-full appearance-none cursor-pointer accent-[#f15a09]"
                    />
                  </div>
                  <div className="flex flex-col gap-1">
                    <div className="flex justify-between items-center px-0.5">
                      <span className="text-[9px] font-black text-slate-400 uppercase">kontras</span>
                      <span className="text-[9px] font-black text-[#f15a09]">{currentEdit.contrast}</span>
                    </div>
                    <input
