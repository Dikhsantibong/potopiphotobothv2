...
function getEnvPath(): string {
  if (process.env.MUTABLE_ENV_PATH) {
    console.log(`[Env API] Using explicitly provided mutable path: ${process.env.MUTABLE_ENV_PATH}`);
    return process.env.MUTABLE_ENV_PATH;
  }
