    ...
    <div className="relative h-screen w-full overflow-hidden bg-[#f15a09] font-sans text-slate-900 flex flex-col p-2 sm:p-3">
      ...
      <div className="relative flex-1 flex flex-col border-[4px] border-white rounded-[30px] overflow-hidden bg-[#f15a09] min-h-0">
        ...
        <div className="shrink-0 flex justify-center py-2">
          ...
          <button onClick={() => setShowBackConfirm(true)} className="bg-white/20 hover:bg-white/30 backdrop-blur-md text-white border-2 border-white/50 px-4 py-1.5 rounded-full font-black text-[9px] tracking-[0.15em] transition-all active:scale-95 flex items-center gap-1.5 shadow-lg">
        ...
        <main className="flex-1 flex flex-col gap-3 px-4 pb-4 min-h-0 overflow-hidden">
          ...
          <div className="flex-1 flex flex-row gap-4 min-h-0 overflow-hidden">
            ...
            <div className="flex-[1.65] flex flex-col min-h-0 min-w-0 gap-2">
              ...
              <h2 className={`${mochiyPopOne.className} text-white text-base sm:text-lg uppercase tracking-widest text-center shrink-0 drop-shadow-md`}>SESI POTRET</h2>
          ...
          <div className="flex-1 min-h-0 bg-white rounded-[20px] shadow-2xl overflow-hidden relative border-3 border-white">
              ...
              <div className="absolute inset-0 bg-slate-900 overflow-hidden">
                ...
                {(countdown !== null || videoCountdown !== null) && (
                   ...
                   <div className="absolute inset-0 flex items-center justify-center z-30 bg-black/20">
                      ...
                      <span className={`${mochiyPopOne.className} text-[6rem] lg:text-[8rem] text-white animate-ping`}>{countdown ?? videoCountdown}</span>
              ...
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-40 w-full flex items-center justify-center px-4 gap-3">
                ...
                {!(showCoverPreview || showVideoPreview) ? (
                  ...
                  <div className="flex gap-3 w-full max-w-sm">
                    ...
                    <button onClick={handleRetake} className="flex-1 h-11 rounded-xl bg-[#f15a09] text-white font-black text-sm shadow-lg uppercase border-2 border-white/30 hover:brightness-110 active:scale-95 transition-all">ULANGI</button>

                    <button onClick={handleNextStage} className="flex-1 h-11 rounded-xl bg-[#f15a09] text-white font-black text-sm shadow-lg uppercase border-2 border-white/30 hover:brightness-110 active:scale-95 transition-all">
            ...
            <div className="flex-1 flex flex-col min-h-0 min-w-0 gap-2">
              ...
              <h2 className={`${mochiyPopOne.className} text-white text-base sm:text-lg uppercase tracking-widest text-center shrink-0 drop-shadow-md`}>PREVIEW</h2>
                ...
                <div className="flex flex-col gap-1.5 shrink-0">
                  ...
                  <div className="flex flex-row gap-2">
                    ...
                    {filters.map(f => (
                      ...
                      <button key={f.id} onClick={() => updateEdit("activeFilter", f.id)} className={`w-9 h-9 shrink-0 rounded-full ${f.color} border-3 transition-all relative ${((stage === "cover" || showCoverPreview) ? coverEdit.activeFilter : videoEdit.activeFilter) === f.id ? "border-[#f15a09] scale-110 shadow-lg" : "border-white shadow-inner opacity-80"}`}>
